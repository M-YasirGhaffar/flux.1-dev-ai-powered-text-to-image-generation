...
const Usage = () => {
  return (
    <div className="max-w-2xl mx-auto">
      <h1 className="text-4xl sm:text-5xl font-bold mb-6 text-[#008080]">How to Use FLUX.1-schnell</h1>
      <ol className="list-decimal list-inside space-y-3 text-gray-300 font-sans">
        ...
        <li className='font-sans'>
          <span className="font-semibold">Generate Image:</span> Click the "Generate Image" button to start the process. The AI model <span className="font-bold">FLUX.1-schnell</span> (powered by Hugging Face's API) will interpret your prompt and generate an image.
        </li>
        <li className='font-sans'>
          <span className="font-semibold">Wait for the Result:</span> Image generation usually takes just a few seconds, though it could take longer if the backend server on Render.com is experiencing high traffic or has been inactive. You’ll see a loading indicator while the image is being generated.
        </li>
        <li className='font-sans'>
      ...
      <p className="mt-4 text-gray-300 font-sans">
        This is an experimental project, so results might sometimes be inaccurate or unexpected. Your experience with <span className="font-bold">FLUX.1-schnell</span> is a journey of creativity and discovery, and we appreciate your understanding!
      </p>
    </div>
  );
};
